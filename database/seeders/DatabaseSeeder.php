...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Template::firstOrCreate(['slug' => 'editorial-luxury'], ['name' => 'Editorial Luxury', 'description' => 'A high-fashion editorial invitation experience.', 'category' => 'editorial', 'component_key' => 'editorial-luxury', 'supported_event_types' => ['wedding', 'engagement'], 'default_settings' => InvitationTemplateSettings::editorialLuxuryDefaults(), 'is_active' => true, 'is_customer_selectable' => true, 'display_order' => 4]);
