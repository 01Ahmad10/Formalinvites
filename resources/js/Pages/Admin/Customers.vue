...
const form = useForm({ name: '', phone: '', guest_capacity: '', allowed_events: '1', primary_name: '', primary_email: '', primary_password: '', secondary_name: '', secondary_email: '', secondary_password: '' });
