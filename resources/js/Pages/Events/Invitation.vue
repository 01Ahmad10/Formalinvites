...
const props = defineProps<{ event: any; templates: any[]; overrides: any; resolvedSettings: any; parties: any[]; canManage: boolean; previewInvitation: any }>();
