...
Route::middleware('auth')->group(function () {
    ...
    Route::post('events/{event}/publication/submit', [EventPublicationController::class, 'submit'])->name('events.publication.submit');
    Route::patch('events/{event}/publication/under-review', [EventPublicationController::class, 'underReview'])->name('events.publication.under-review');
    Route::patch('events/{event}/publication/request-changes', [EventPublicationController::class, 'requestChanges'])->name('events.publication.request-changes');
    Route::patch('events/{event}/publication/approve', [EventPublicationController::class, 'approve'])->name('events.publication.approve');
